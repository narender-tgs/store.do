    ...
    <main className="main">
      ...
      <div className="container">
        ...
        <div className="wishlist-title" style={{ textAlign: "center" }}>
          ...
          <p>
            Your order has been successfully placed. We're excited to get your
            purchase on its way to you. If you have any questions or need to
            make changes, feel free to reach out. Keep an eye on your inbox for
            updates and tracking information. Thanks again for choosing us!
          </p>
        </div>
