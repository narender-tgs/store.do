  ...
  return (
    <main className="main about">
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn more about us and our mission to provide excellent services."
        />
        <meta
          name="keywords"
          content="about us, company history, our mission"
        />
      </Helmet>
      <div
      ...
      >
        <div className="container">
          ...
          <ALink href="/pages/contact-us" className="btn btn-dark">
            Contact
          </ALink>
        </div>
      </div>
