  ...
  return (
    <main className="main">
      <Helmet>
        ...
        <meta
          name="description"
          content="Contact us today for more information or to get started with our services."
        />
        ...
        <div className="contact-info">
          <div className="row">
            <div className="col-12">
              ...
              <p>
                You can directly contact us , at Shopaholic Emporium is located
                at 123 Main Street, Suite 101, Cityville, State. You can reach
                us at (555) 123-4567 or via email at
                info@shopaholicemporium.com. Trendy Threads Co. can be found at
                456 Fashion Avenue, Unit B, Trendytown, State. Contact us at
                (555) 987-6543 or email support@trendythreadsco.com. Chic
                Boutique's address is 789 Style Boulevard, Chicville, State.
                Feel free to call us at (555) 456-7890 or email
                hello@chicboutique.com.
              </p>
            </div>
          ...
          <div className="col-lg-6">
            ...
            <div id="accordion">
              <Accordion adClass="accordion-simple">
                <Card
                  title="How will I detect fraudulent emails/calls seeking sensitive personal and confidential information?"
                  adClass="card-accordion"
                >
                  <p>
                    If you receive an e-mail, a call from a person/association
                    claiming to be from Store.Do seeking sensitive confidential
                    information like debit/credit card PIN, net-banking or
                    mobile banking password, we request you to never provide
                    such confidential and personal data. We at Store.Do or our
                    ...
                    enforcement agency. Here are a couple of baits fraudsters
                    often use to cheat consumers: Congratulations! You have been
                    nominated as a ‘Top Store.Do customer’ and are now eligible
                    for a luxury gift item. Please share your proof of address
                    and your debit/credit card details to avail this great
                    offer. Hi, I’m calling from Store.Do. We are happy to let
                    you know that you have won an exclusive lucky draw coupon of
                    Rs. 5000 on your latest purchase. Please share your
                    credit/debit card number so we can credit the money directly
                    into your bank account.
                  </p>
                </Card>

                <Card
                  title="Why will 'My Cashback' not be available on Store.Do?"
                  adClass="card-accordion"
                >
                  <p>
                    To make your shopping experience easier and simpler, 'My
                    Cashback' will be replaced by PhonePe. PhonePe wallet can be
                    used on Store.Do and other PhonePe partners. To use your
                    PhonePe balance, you will have to activate/verify your
                    PhonePe account
                  </p>
                </Card>
                ...
                <Card
                  title="I have created a Return request. When will I get the refund?"
                  adClass="card-accordion"
                >
                  <p>
                    Refund will be initiated upon successful pickup as per the
                    Returns Policy. The refund amount is expected to reflect in
                    the customer account within the following timelines: NEFT -
                    1 to 3 business days post refund initiation Store.Do Credit
                    - Instant Online Refund – 7 to 10 days post refund
                    initiation, depending on your bank partner “PhonePe wallet”
                    – Instant Note: You can maintain up to five bank accounts
                    for NEFT/IMPS refunds and a single bank account can be
                    linked upto five Store.Do accounts. If you wish to add a new
                    bank account over and above, please delete an existing bank
                    account.
                  </p>
                </Card>
              </Accordion>
