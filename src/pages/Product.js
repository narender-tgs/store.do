              ...
              <>
                ...
                {categoryObj?.subCategory &&
                  ...
                  <>
                    ...
                    <li className="breadcrumb-item">
                      <ALink
                        href={`/shop/${grid}?category=${categoryObj.subCategory.parentCatGuid}`}
                        scroll={false}
                      >
                        {categoryObj?.subCategory?.parentCatName}
                      </ALink>
                    ...
                    <li className="breadcrumb-item active">
                      <ALink
                        href={`/shop/${grid}?category=${categoryObj.subCategory.subCatGuid}`}
                        scroll={false}
                      >
                        {categoryObj?.catName}
                      </ALink>
                  ...
                  <>
                    ...
                    <li className="breadcrumb-item active">
                      <ALink
                        href={`/shop/${grid}?category=${categoryObj?.catGuid}`}
                        scroll={false}
                      >
                        {categoryObj?.catName}
                      </ALink>
              ...
              <div className="toolbox-right">
                ...
                <div className="toolbox-item layout-modes">
                  <ALink
                    ...
                    className="layout-btn btn-grid active mr-2"
                    title="Grid"
                  >
