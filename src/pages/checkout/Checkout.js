   ...
   const [orderGuid , setOrderGuid] = useState();
    ...
    const handleSubmit = (e) => {
        ...
        if (hasErrors) {
            ...
            toast.warning("please fill shipping  details before placing order!", {
                                ...
                                <ul className="checkout-steps">
                                    <li>
                                        ...
                                        <form action="#" id="checkout-form" onSubmit={handleSubmit}>
                                            ...
                                            <div className="form-group">
                                                <input type="text" name="shipping_street2" onChange={handleChange} className="form-control"
                                                    ...
                                                    { ( { onToggle, setCollapsibleElement } ) => (
                                                        <div className="form-group mb-11">
                                                            <div className="custom-control custom-checkbox mt-0 address-box">
                                                                ...
                                                                <label className="custom-control-label" htmlFor="different-shipping">Add different billing address?
                                                    </label>
                                                            </div>
                                                            <div className="shipping-info" ref={ setCollapsibleElement } style={ { overflow: 'hidden' } }>
                                                                ...
                                                                <div className="form-group">
                                                                    <input type="text"  name="billing_stree2" onChange={handleChange} className="form-control"
                                        ...
                                        <tfoot>
                                            ...
                                            <tr className="order-total">
                                                ...
                                                <td>
                                                    ...
                                                    <b className="total-price"><span>&#x20B9;{subtotal}</span></b>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
