...
function BannerSection() {
  ...
  const bottomPosition =
    ...
    storeDetails?.storeDetails?.banners.filter((bann) =>
      bann?.bannerPosition?.includes("Bottom"),
    );
  ...
  return (
    <section className="banners-section mb-4">
      <div className="row row-sm m-0">
        ...
        <div
          className="col-md-12 pr-0 pl-0 pl-md-2"
          style={{ height: "465px" }}
        >
          <div
            className="banner banner2 h-100"
            style={{
              background: `#101010 no-repeat center/cover url(${bannerFirstUrl})`,
            }}
          >
            ...
            <ALink
              href={`/product/Sale/${bannerFirstId}`}
              state={bannerFirstId}
