...
export default function TrendyCollection(props) {
  ...
  const bannerMidTwo =
    ...
    storeDetails?.storeDetails?.banners.filter(
      (bann) =>
        bann?.bannerPosition?.includes("Middle") &&
        bann?.bannerPosition?.includes("Two"),
    );
  const bannerMidOne =
    storeDetails?.storeDetails?.banners &&
    storeDetails?.storeDetails?.banners.filter(
      (bann) =>
        bann?.bannerPosition?.includes("Middle") &&
        bann?.bannerPosition?.includes("One"),
    );
  ...
  return (
    <section className="trendy-section mb-2">
      <div className="container">
        ...
        >
          <OwlCarousel
            adClass="products-slider show-nav-hover nav-image-center"
          ...
          <div className="col-xl-6 mb-2">
            <div className="banner banner3 d-flex flex-wrap align-items-center bg-gray h-100">
              ...
              <div className="col-sm-4 text-center">
                ...
                <ALink
                  href={`/product/Sale/${bannerOneGuid}`}
                  state={bannerOneGuid}
          ...
          <div className="col-xl-6 mb-2">
            <div className="banner banner4 d-flex flex-wrap align-items-center bg-primary h-100">
              ...
              <div className="col-sm-4 text-center">
                ...
                <ALink
                  href={`/product/Sale/${bannerTwoGuid}`}
                  state={bannerTwoGuid}
                  className="btn btn-dark btn-lg"
                >
                  Shop all sale
