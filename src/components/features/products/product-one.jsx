                    ...
                    import CartMenu from '../../common/partials/cart-menu';
                    function ProductOne ( props ) {
                        ...
                        const onAddCartClick= (ProductDetail)=> {
                            ...
                            <div className={ `product-default media-with-lazy ${adClass}` }>
                                <figure>
                                    {/* <ALink href={ `/product/${link}/${product.slug}` }> */}
                                        ...
                                        />
                                        {/* {
                                           product && product.srcs && product.srcs.length >= 2 ?
                                                <LazyLoadImage
                                                    alt="product"
                                    ...
                                    <div className="product-action">
                                        {
                                            product.variants.length > 0 ?
                                                ...
                                                : 
                                                <Link className="btn-icon btn-dark btn-add-cart product-type-simple" title="Add To Cart" onClick={() => onAddCartClick(product)}><i className="icon-shopping-cart"></i>ADD TO CART</Link>
                                                // <a href="#" className="btn-icon btn-dark btn-add-cart product-type-simple" title="Add To Cart" onClick={ onAddCartClick(product) }><i
