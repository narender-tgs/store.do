...
function ProductWidgetContainer(props) {
  ...
  return (
    <section
      className={`product-widgets-container custom-widgets pb-2 skeleton-body skel-shop-products pt-5 ${loading ? "" : "loaded"} ${adClass}`}
    >
        ...
        <div className="row">
          <div className="col-lg-3 col-sm-6 pb-5 pb-lg-0">
            {loading ? (
              ...
              <>
                <h4 className="section-sub-title ls-n-25 pb-2 mb-1">
                  Featured Products
                </h4>
